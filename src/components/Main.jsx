...
async function playAudioStream(
	...
	const audioStreamRes = await getAudioStream(speechifyAuthToken, inputText, voiceId);
...
async function runTextToSpeech(
	...
	const play = () => {
		playAudioStream(sourceBuffer, audioPlayer, speechifyAuthToken, inputText, voiceId);
	};
